...
const SlideShow = () => {
  ...
  useEffect(function () {
    ...
    axios({
      ...
      .then((result) => {
        console.log(result);
        setYangonWeatherData(result.data);
      })
      .catch((err) => console.log(err));
    axios({
      method: "GET",
      ...
      .then((result) => {
        console.log(result);
        setMandalayWeatherData(result.data);
      })
      .catch((err) => console.log(err));
  }, []);
              ...
              <div className="container weather">
                <div className="row">
                  <div className="col-md-3">
                    ...
                    <img
                      src={yangonWeatherData.Icon}
                      style={{ width: "100px", height: "100px" }}
                    ></img>
                  </div>
                  <div className="col-md-2 element">
                    <h5 className="title">Description</h5>
                    <h6>{yangonWeatherData.Description} </h6>
                  </div>
                  <div className="col-md-2 element">
                    <h5 className="title">Weather</h5>
                    <h6>{yangonWeatherData.Weather}</h6>
                  </div>
                  <div className="col-md-2 element">
                    <h5 className="title">AQI</h5>
                    <h6>{yangonWeatherData.AQI} </h6>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-3">
                    ...
                    <img
                      src={mandalayWeatherData.Icon}
                      style={{ width: "100px", height: "100px" }}
                    ></img>
                  </div>
                  <div className="col-md-2 element">
                    <h5 className="title">Description</h5>
                    <h6>{mandalayWeatherData.Description} </h6>
                  </div>
                  <div className="col-md-2 element">
                    <h5 className="title">Weather</h5>
                    <h6>{mandalayWeatherData.Weather}</h6>
                  </div>
                  <div className="col-md-2 element">
                    <h5 className="title">AQI</h5>
                    <h6>{mandalayWeatherData.AQI} </h6>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <iframe className="video" src="https://www.youtube.com/embed/EbENZ16qL-M" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
    </iframe>
        </div>
      </div>
